...
class Game():          
    ...
    def run(self):
        ...
        bs = Button(FONT.render('Start VOOR REINIER', 1, FONT_COLOR), self.screen, 0,-1)
        ...
        while mainloop:
            ...
            if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                ...
                if bp2.collidepoint(pos) and self.curpage == 'PlayerSelect':
                    ...
                    bpy = Button(FONT.render('Red', 1, YELLOW), self.screen, ((self.scr_width/6)*5, 1.7*OFFSET),0,3)
